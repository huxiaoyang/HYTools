...
//  BSKit
//
//  Created by ucredit-XiaoYang on 16/4/8.
...
static const CGFloat void_defaultInterval = 0.0;
...
@implementation UIControl (BSTouch)
...
- (NSTimeInterval)bs_touchTimeInterval {
    return [objc_getAssociatedObject(self, _cmd) doubleValue];
}
- (void)setBs_touchTimeInterval:(NSTimeInterval)bs_touchTimeInterval {
    objc_setAssociatedObject(self, @selector(bs_touchTimeInterval), @(bs_touchTimeInterval), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
